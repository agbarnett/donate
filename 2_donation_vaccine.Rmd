...
fplot
jpeg('figures/education_donation.jpg', width=5.5, height=6, units='in', res=500)
print(fplot)
invisible(dev.off())
```
...
fplot
jpeg('figures/altruism_donation.jpg', width=5.5, height=6, units='in', res=500)
print(fplot)
invisible(dev.off())
```
...
fplot
jpeg('figures/risk_donation.jpg', width=5.5, height=6, units='in', res=500)
print(fplot)
invisible(dev.off())
```
...
fplot
jpeg('figures/income_donation.jpg', width=5.5, height=6, units='in', res=500)
print(fplot)
invisible(dev.off())
```
