...
cat('model{
  ...
  ## Priors
  for (k in 1:4){beta[k] ~ dnorm(0, 0.00001)}
  # ordered cut-offs
...
###
# save results
save(countries, n.country, poll_labels, bugs.results, bugs.results.fixed, file='results/bugs_ordinal_model_politics.RData')
