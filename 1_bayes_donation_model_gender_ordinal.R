...
categories = 'four' 
# results are saved
outfile = 'results/bugs_ordinal_model_gender.RData'
if(categories == 'four'){
  outfile = 'results/bugs_ordinal_model_gender_four.RData'
}
...
###
# save results
save(countries, n.country, glabels, bugs.results, bugs.results.fixed, file=outfile)
